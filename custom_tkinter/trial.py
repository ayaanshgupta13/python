...
side_img_data = Image.open("custom_tkinter/side-img.png")
...
CTkButton(master=frame, text="Create account", fg_color="#601E88", hover_color="#E44982", font=("Arial Bold", 12), text_color="#ffffff", width=225,command=lambda:d()).pack(anchor="w", pady=(40, 0), padx=(25, 0))
