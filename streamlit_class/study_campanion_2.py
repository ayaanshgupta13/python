...
#         "nav-link-selected": {"background-color": "#ff2020"},
#     },
# )
...
# rad=st.sidebar.radio("Math",["Integer(day 1)",'Geometry(day 2)','Fraction(day 3)',"Algebra(day 4)","quiz"])
with st.sidebar:
    rad = option_menu(menu_title="Topics",options=["Home","Integer(day 1)","Geometry(day 2)","Fraction(day 3)","Algebra(day 4)","quiz"])
...
if rad == "Algebra(day 4)":
    ...
    # with st.expander("📝 Quiz Time!"):
    #     st.write("Test your knowledge with these questions!")
    #     q1 = st.radio("1. What is the value of x in the equation 2x + 3 = 11?", ["x = 3", "x = 4", "x = 5"])
    #     if q1 == "x = 4":
    #         st.success("Correct!")
    #     elif q1:
    #         st.error("Try again.")
        
    #     q2 = st.radio("2. Simplify: 5x + 3x - 2x", ["6x", "8x", "10x"])
    #     if q2 == "6x":
    #         st.success("Correct!")
    #     elif q2:
    #         st.error("Try again.")
        
    #     q3 = st.radio("3. What is the result of (3 + 2) × 4?", ["20", "14", "24"])
    #     if q3 == "20":
    #         st.success("Correct!")
    #     elif q3:
    #         st.error("Try again.")
...
if rad == "quiz":
    ...
    st.text("try out other games: ")
    # if st.button("Quiz game"):
    #     run_tkinter()